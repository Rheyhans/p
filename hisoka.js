...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/4f3dee7dffb0a32ba9d0d.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Dana/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6285895001126 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://www.paypal.me/\n⭔ Saweria : https://saweria.co/rheyhanputra` }, { quoted: m })
            }
            break
            case 'chat': {
...
⭔ Url : ${anu.url}`,
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
	        ...
	        case 'tiktok': case 'tiktoknowm': {
                ...
                m.reply(mess.wait)
                let { author: { nickname }, video, description } = await scraper.tiktokdl(text) 
               let uri = video.no_watermark
               let buttons = [
